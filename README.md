...
- [`node-mongodb-migrations`](https://github.com/neverbot/node-mongodb-migrations), forked from [ikatun/node-migrate](https://github.com/ikatun/node-migrate), in turn forked from [tj/node-migrate](https://github.com/tj/node-migrate) by [TJ Holowaychuk](https://github.com/tj).
